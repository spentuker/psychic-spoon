import java.util.*;
public class removeFreq {
    // THERE IS A LAyman version of this in my notebookk. Its just using an array and storing freqs, removing freq of one and then checking the array. 
    public static void main(String[] args) {
        ...
        String[] testCases = {
            ...
            "aabbcccdd",   // ✅ true
            "aabbbcc",     // ✅ true
            "aaaabbbbccccddd", // ❌ false
            "a",           // ✅ true
            "abcdeff"      // ✅ true (remove one 'f')
        };

        for (String word : testCases) {
            boolean result = sol.equalFrequency(word);
